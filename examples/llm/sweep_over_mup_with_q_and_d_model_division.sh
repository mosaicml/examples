...
do
    ...
    composer main.py \
        yamls/mosaic_gpt/small_mup_scaling.yaml \
            ...
            run_name=small_2_layers_mup_with_Wq_on_divide_by_d_model_logits_scaled_d_model_${d_model}_n_head_${n_heads} no_bias=True mup_config.debug=False mup_config.scale_logits_by_ratio = False
done
done