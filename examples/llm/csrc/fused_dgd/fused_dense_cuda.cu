// Copied from from https://github.com/mlcommons/training_results_v2.0/blob/a6ae3e16d97bca208ee5510f3614fcd4fa923650/HazyResearch/benchmarks/bert/implementations/pytorch/csrc/fused_dense_lib/fused_dense_cuda.cu
// which was adapted from https://github.com/NVIDIA/apex/blob/master/csrc/fused_dense_cuda.cu
#include <ATen/ATen.h>
...
template int linear_bias_backward_cuda<float>(float *input, float *weight, float *d_output, int in_features, int batch_size, int out_features, float *d_weight, float *d_bias, float *d_input, bool residual, void *lt_workspace) ;

template int linear_bias_backward_cuda<double>(double *input, double *weight, double *d_output, int in_features, int batch_size, int out_features, double *d_weight, double *d_bias, double *d_input,  bool residual, void *lt_workspace) ;
...
template int linear_bias_wgrad_cuda<float>(float *input, float *d_output, int in_features, int batch_size, int out_features, float *d_weight, float *d_bias, void *lt_workspace) ;

template int linear_bias_wgrad_cuda<double>(double *input, double *d_output, int in_features, int batch_size, int out_features, double *d_weight, double *d_bias, void *lt_workspace) ;


template int linear_gelu_forward_cuda<at::Half>(at::Half *input, at::Half *weight, at::Half *bias, int in_features, int batch_size, int out_features, at::Half *output, at::Half *gelu_in, void *lt_workspace) ;

template int linear_gelu_forward_cuda<float>(float *input, float *weight, float *bias, int in_features, int batch_size, int out_features, float *output, float *gelu_in, void *lt_workspace);

template int linear_gelu_forward_cuda<double>(double *input, double *weight, double *bias, int in_features, int batch_size, int out_features, double *output, double *gelu_in, void *lt_workspace) ;
