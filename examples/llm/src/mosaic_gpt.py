...
import examples.llm.src.modules.attention_modules as attention_modules
import examples.llm.src.modules.gpt_blocks as gpt_blocks
...
class MosaicGPT(nn.Module):
    ...
    def __init__(self, cfg: DictConfig):
        ...
        if cfg.attn_impl == 'torch':
            self.causal_attn_cls = attention_modules.TorchCausalAttention
        elif cfg.attn_impl == 'flash':
            self.causal_attn_cls = attention_modules.FlashCausalAttention
        elif cfg.attn_impl == 'triton':
            self.causal_attn_cls = attention_modules.TritonFlashCausalAttention
        else:
