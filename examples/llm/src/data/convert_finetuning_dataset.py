...
from examples.common.convert_dataset import (MDSWriter, build_dataloader,
                                             generate_samples)
...
class SimpleDataset(IterableDataset):
    ...
    def __iter__(self) -> Iterable[Dict[str, bytes]]:
        for sample in self.hf_dataset:
            ...
            yield {
                key: sample.get(key, '').encode('utf-8') for key in self.columns
            }
...
def main(args: Namespace) -> None:
    ...
    for split_name in args.splits:
        ...
        with MDSWriter(out=out,
                       columns={key: 'str' for key in args.columns},
...
if __name__ == '__main__':
    """Example for converting Muennighoff/P3:
        ...
        >>> python src/data/convert_finetuning_dataset.py --dataset "Muennighoff/P3" --splits train validation --columns inputs targets --out_root s3://<bucket>/meunnighoff-p3
    """
    main(parse_args())
