...
def main(args):
    ...
    for seed in args.seeds:
        ...
        rn = f"schedule-{args.scheduler}-{args.initial_mlm_rate}-{args.final_mlm_rate}"
        if args.model == "large":
        ...
        if args.subset_mask:
            ...
            run.parameters["loggers"]["wandb"]["group"] = "subset-mask-" + run.parameters["loggers"]["wandb"]["group"]
