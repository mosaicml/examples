...
def parse_args() -> Namespace:
    ...
    parser.add_argument('--dataset', type=str, default="pile-of-law/pile-of-law")
    ...
    parser.add_argument('--splits',
                        nargs='+',
                        default=['train', 'train_small', 'val', 'val_small'])
...
pileoflawconstants = DatasetConstants(
    chars_per_sample=2163,  # Computed over validation set
    chars_per_token=4  # OpenAI estimate
)
pileoflawconstants.splits['train'] = DataSplitConstants(hf_split='train',
                                                 folder_split='train',
                                                 raw_samples=None,
                                                 truncated_samples=None)
pileoflawconstants.splits['train_small'] = DataSplitConstants(
    hf_split='train',
...
pileoflawconstants.splits['val'] = DataSplitConstants(hf_split='validation',
                                               ...
                                               raw_samples=None,
                                               truncated_samples=None)
pileoflawconstants.splits['val_small'] = DataSplitConstants(hf_split='validation',
                                                     folder_split='val_small',
                                                     raw_samples=None,
                                                     truncated_samples=10000)

CONSTS = {'pile-of-law/pile-of-law': pileoflawconstants}
...
def main(args: Namespace) -> None:
    ...
    try:
        ...
        raise ValueError(
            f'Constants for dataset "{args.dataset}" not found. Currently only "pile of law" is supported.'
        )
