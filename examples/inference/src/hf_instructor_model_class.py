...
"""Custom model handler class for instructor model"""
class HFInstructorLargeModel(BaseModelHandler):
    ...
    def predict(self, **inputs: Dict[str, Any]):
        """
        Runs a forward pass with the given inputs. Inputs must be dictionary
        that contains a 'input_strings' key with the value being in the following
        format:
